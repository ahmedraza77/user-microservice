...
public class UserRepositoryTest {
	...
	final void testGetVerifiedUsers() {
		...
		Page<UserEntity> page = userRepository.findAllUsersWithConfirmedEmail(pageableRequest);
		assertNotNull(page);
	...
	{
		String keyword="erg";
		List<Object[]> users = userRepository.findFirstAndLastNameByKeyword(keyword);
		assertNotNull(users);
		assertTrue(users.size() == 2);
	...
	final void testUpdateUserEmailVerificationStatus()
	{
		...
		userRepository.updateEmailVerificationStatus(newEmailVerificationStatus, "1a2b3c");
